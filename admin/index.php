                                    ...
                                    <div class="col">
                                        <div class="card bg-secondary text-white">
                                            <div class="card-body"> Inactive:
                                                <span style="font-size:22px;"> <?php echo $inactiveproducts; ?></span>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-warning text-white">
                                            <div class="card-body">Last 24h Added:
                                                <span style="font-size:22px;"> <?php echo $yesterdayproducts; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card bg-info text-white">
                                            <div class="card-body"> Last 7 days added:
                                                <span style="font-size:22px;"> <?php echo $last7daysproducts; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="products.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-primary text-white">
                                            <div class="card-body">Last 30 days added:
                                                <span style="font-size:22px;"> <?php echo $last30daysproducts; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="products.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-success text-white">
                                            <div class="card-body">Total:
                                                <span style="font-size:22px;"> <?php echo $totalproducts; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="products.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card bg-secondary text-white">
                                            <div class="card-body"> Inactive:
                                                <span style="font-size:22px;"> <?php echo $inactiveoffers; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card bg-warning text-white">
                                            <div class="card-body">Last 24h Added:
                                                <span style="font-size:22px;"> <?php echo $yesterdayoffers; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card bg-info text-white">
                                            <div class="card-body"> Last 7 days added:
                                                <span style="font-size:22px;"> <?php echo $last7daysoffers; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="offers.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-primary text-white">
                                            <div class="card-body">Last 30 days added:
                                                <span style="font-size:22px;"> <?php echo $last30daysoffers; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="offers.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-success text-white">
                                            <div class="card-body">Total:
                                                <span style="font-size:22px;"> <?php echo $totaloffers; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="offers.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-secondary text-white">
                                            <div class="card-body"> Unassigned SubCategories:<br />
                                                <span style="font-size:22px;"> <?php echo $unassigned; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card bg-warning text-white">
                                            <div class="card-body">Site Active Categories:<br />
                                                <span style="font-size:22px;"> <?php echo $siteactivecats . ' / ' . $sitecats; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col">
                                        <div class="card bg-info text-white">
                                            <div class="card-body"> Site Active SubCategories:<br />
                                                <span style="font-size:22px;"> <?php echo $siteactivesubcats . ' / ' . $sitesubcats; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="categories.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-primary text-white">
                                            <div class="card-body">Vendors Active Categories:<br />
                                                <span style="font-size:22px;"> <?php echo $vendoractivecats . ' / ' . $vendorcats; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="vendors.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    ...
                                    <div class="col">
                                        <div class="card bg-success text-white">
                                            <div class="card-body">Vendors Active SubCats:<br />
                                                <span style="font-size:22px;"> <?php echo $vendoractivesubcats . ' / ' . $vendorsubcats; ?></span>
                                            </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="vendors.php">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
